...
const PlayingPage = () => {
    return <div>
        ...
        <div className="flex flex-col gap-8">
            <VideoBox title="사냥감에 빙의 해보자! 낚시 놀이" titleImg={fishImg} youtubeVideoId="" />
            <VideoBox title="신나게 달려보자! 축구 놀이" titleImg={soccerImg} youtubeVideoId="" />
            <VideoBox title="마초의 최애 놀이! 던지기 놀이" titleImg={basketballImg} youtubeVideoId="" />
            <VideoBox title="숨었다가 기습! 술래잡기" titleImg={tagImg} youtubeVideoId="" />
        </div>
    </div>
}
